...
def test_set_global_settings_requires_connection(instance):
    instance._connected = False

    instance.set_global_settings({'a': 1})

    assert instance.ws.sent == []
    assert instance.global_settings is None
...
def test_get_global_settings_requires_connection(instance):
    instance._connected = False
