...
class RecordingAction:
    def __init__(self, action='com.qxb.music.music', context='ctx'):
        self.action = action
...
def test_will_appear_creates_and_stores_action(instance, monkeypatch):
    ...
    monkeypatch.setattr(
        'core.action_factory.ActionFactory.create_action',
...
def test_will_appear_passes_settings_to_factory(instance, monkeypatch):
    ...
    monkeypatch.setattr(
        'core.action_factory.ActionFactory.create_action', classmethod(create)
    )
    ...
    assert seen['action'] == 'com.qxb.music.music'
...
def test_will_appear_keeps_registry_clean_when_creation_fails(instance, monkeypatch):
    ...
    send(instance, event='willAppear', context='ctx', action='com.qxb.music.music')
...
def test_get_action_and_get_actions(instance):
    music = RecordingAction(action='com.qxb.music.music', context='a')
    custom = RecordingAction(action='com.qxb.music.custom', context='b')
    instance.actions = {'a': music, 'b': custom}

    assert instance.get_action('a') is music
    assert instance.get_action('missing') is None
    assert instance.get_actions('com.qxb.music.music') == [music]
    assert instance.get_actions('com.qxb.music.unknown') == []
